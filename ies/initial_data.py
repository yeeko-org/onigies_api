...
class InitStatus:
    def __init__(self):
        init_status = [
            ...
            ("filling", "register", "En llenado",
                "blue", "edit_document", False, 'ies', False, 8),
            ("sent", "register", "Enviado (para revisarse)",
                "green", "pending_actions", True, 'validator', False, 6),
            ("need_changes", "register", "Requiere cambios",
                "orange", "new_releases", False, 'ies', False, 2),
            ("requires_new_checking", "register", "Requiere nueva revisión",
                "pink", "report_gmailerrorred", False, 'validator', False, 4),
